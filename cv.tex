...
\textbf{Embedded Systems:} Microcontroller development (ARM Cortex-M, NRF5x, Zephyr, Arduino, Raspberry Pi), bare-metal driver development, PCB design (Altium), PCB layup (soldering, cable harnessing), BLE, SPI, I2C, CAN, NOR/NAND Flash\\
\textbf{Cloud:} AWS architecture \& development (ECS, EC2, S3, RDS, etc), CI/CD (Github Actions, Jenkins, AWS CodePipeline), Docker \\
\textbf{AI/ML:} NumPy, Pandas, SciPy, Sympy, OpenCV, Embodied AI/ML (Bayes Filters, Search, Deep Learning for Robotics)\\
