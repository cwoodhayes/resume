...
\textbf{Embedded Systems} & Microcontroller development (ARM Cortex-M, NRF5x, Zephyr, Arduino, Raspberry Pi), PCB design (Altium), PCB layup (soldering, cable harnessing), BLE, SPI, I2C, CAN\\
